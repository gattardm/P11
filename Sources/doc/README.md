...
* Ajout de l'énoncé du TOGAF
* Ajout d'une conclusion relative à la POC elle-même
	* les composants sont indépendants les uns des autres
	* les composants se connectent bien aux différentes bases de données
	* les bases de données sont sécurisées
	* les retours des bases de données sont authentiques
	* les temps de réponses des requêtes n'excèdent pas les exigences du cahier des charges (30s)	
* Ajout d'un travail par itération pour apport de valeurs --> Agile / Scrum
* Anticipation des pb grace aux itérations
